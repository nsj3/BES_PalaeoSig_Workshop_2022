...
fun_plot <- function(x, y) {
   ...
   svg(paste0("Figures/", y, ".svg"), width=10, height=6)
...
# use package cowplot to draw individual svg files and combine into a single figures

fnames <- list.files("Figures", "*.svg", full.names=TRUE)
